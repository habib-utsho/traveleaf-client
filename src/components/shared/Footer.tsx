...
const Footer = () => {
  const footerLink = [
    ...
    { link: "package", text: "Package" },
    { link: "contact", text: "Contact" },
    { link: "", text: "Couple Travel" },
    { link: "privacy-policy", text: "Privacy Policy" },
    { link: "user-agreement", text: "User Agreement" },
    { link: "content-policy", text: "Content Policy" },
    { link: "", text: "Adventure" },
    { link: "", text: "Family Tour" },
  ];
      ...
      <Container className="grid gap-10 md:gap-6 grid-cols-1 md:grid-cols-2 xl:grid-cols-4 py-20">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <span className="flex items-center justify-center h-10 w-10 rounded-full bg-slate-800 text-slate-50 cursor-pointer hover:scale-110 transition">
              <FacebookFilled />
            </span>
            <span className="flex items-center justify-center h-10 w-10 rounded-full bg-slate-800 text-slate-50 cursor-pointer hover:scale-110 transition">
              <GithubFilled />
