    ...
    <div>
      ...
      >
        ...
        >
          ...
          <div className="flex gap-[2px] flex-col p-2 rounded-lg bg-gray-800 hover:bg-gray-700 transition duration-200">
            <span className="font-semibold !text-primary flex items-center gap-1">
              {post.author?.name}{" "}
              {post?.author?.user?.status === "premium" && (
                <span className="h-5 w-5 rounded-full flex items-center justify-center  text-primary text-xl">
                  <VerifiedBadgeIcon />
                </span>
              )}
            </span>
