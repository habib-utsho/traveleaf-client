...
export const SignOutIcon: React.FC<IconSvgProps> = (props) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
export const NotificationIcon: React.FC<IconSvgProps> = (props) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
export const VerifiedBadgeIcon: React.FC<IconSvgProps> = (props) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
